...
class DigitDataset(data.Dataset):
    def __init__(self, path, train=True, target=5, transform=False):
...
transforms = tfs_2.Compose([tfs_2.ToImage(), tfs_2.ToDtype(dtype=torch.float32, scale=True)])
d_train = DigitDataset(r'C:\datasets\mnist', train=True, target=5, transform=transforms)
